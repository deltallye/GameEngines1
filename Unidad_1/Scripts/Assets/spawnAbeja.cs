...
public class spawnAbeja : MonoBehaviour
{
    public float minY;
    public float maxY;
    public GameObject enemigoGame1;
    float y;
    ...
    void spanEnemigo()
    {
        ...
        Instantiate(enemigoGame1, pos, transform.rotation); //spanear al enemigo en la posicion que acabamos de crear
